...
from code.algoritmes.random_old import random_algoritme_oud
from code.algoritmes.random_new import random_algoritme_nieuw
from code.algoritmes.bfs import breadth_first_search
